...
# module references:
# axi_full2lite_converter, bram, cpu, crossbar_wrap, uart
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_debug_0 [ create_bd_port -dir O clk_debug_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {57.142857} \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {57.1} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS { \
     0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD \
     0#GPIO#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO \
     0#SD 0#SD \
     0#SD 0#SD \
  ...
  if { [catch {set uart_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.clock_frequency {57100000} \
 ] $uart_0
  ...
  connect_bd_intf_net -intf_net crossbar_wrap_0_ram_m_axi [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins crossbar_wrap_0/ram_m_axi]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports gpio_io_o_0] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net bram_0_bram_rddata_a [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins bram_0/bram_rddata_a]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_full2lite_conver_0/aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins cpu_0/aresetn] [get_bd_pins crossbar_wrap_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins uart_0/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_full2lite_conver_0/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins cpu_0/aclk] [get_bd_pins crossbar_wrap_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins uart_0/aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net uart_0_clk_debug [get_bd_ports clk_debug_0] [get_bd_pins uart_0/clk_debug]
  connect_bd_net -net uart_0_tx [get_bd_pins processing_system7_0/UART1_RX] [get_bd_pins uart_0/tx]
  connect_bd_net -net uart_0_uart_tx_cpu_pause [get_bd_pins cpu_0/uart_tx_cpu_pause] [get_bd_pins uart_0/uart_tx_cpu_pause]

  # Create address segments
  assign_bd_address -offset 0x20000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_full2lite_conver_0/m_axi] [get_bd_addr_segs uart_0/axi/reg0] -force
  ...
  assign_bd_address -offset 0x10000000 -range 0x02000000 -target_address_space [get_bd_addr_spaces crossbar_wrap_0/ram_m_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
